...
const VALTREE_MAX_NODES: usize = 100_000;
...
pub(crate) fn try_destructure_mir_constant_for_user_output<'tcx>(
    ...
    let (field_count, variant, down) = match ty.kind() {
        ...
        // This helper is used for user-facing output. Non-aggregate constants
        // are not destructurable, but reporting them must not ICE the compiler.
        _ => return None,
    };
