...
parameterized_over_tcx! {
    ...
    rustc_middle::mir::trust_contract::TrustContract,
    rustc_middle::mir::trust_contract::TrustContractBundle,
    rustc_middle::mir::trust_contract::TrustContractPredicate,
