...
pub(crate) unsafe fn llvm_optimize(
    ...
    // FIXME(ZuseAY): In a future update we could figure out how to only optimize individual functions getting
    // differentiated.
...
pub(crate) fn optimize(
    ...
    // FIXME(ZuseAY): support SanitizeHWAddress and prevent illegal/unsupported opts
