...
fn update_target_reliable_float_cfg(sess: &Session, cfg: &mut TargetConfig) {
    ...
    cfg.has_reliable_f16 = match (target_arch, target_os) {
        // Unsupported <https://github.com/llvm/llvm-project/issues/94434> (fixed in trust_cg2)
        ...
        (Arch::CSky, _) if major < 22 => false, // (fixed in trust_cg2)
        (Arch::PowerPC | Arch::PowerPC64, _) if major < 22 => false, // (fixed in trust_cg2)
        (Arch::Sparc | Arch::Sparc64, _) if major < 22 => false, // (fixed in trust_cg2)
        (Arch::Wasm32 | Arch::Wasm64, _) if major < 22 => false, // (fixed in trust_cg2)
    ...
    cfg.has_reliable_f128 = match (target_arch, target_os) {
        ...
        // ABI unsupported  <https://github.com/llvm/llvm-project/issues/41838> (fixed in trust_cg2)
