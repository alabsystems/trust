...
#[test]
fn ident_adjacency_keeps_character_literals_for_the_cooked_lexer() {
    check_lexing(
        "x' ' x'\\n' x'💩' x'\\'' x'a' x'static",
        FrontmatterAllowed::No,
        expect![[r#"
            ...
            Token { kind: Whitespace, len: 1 }
            Token { kind: UnknownPrefix, len: 1 }
            Token { kind: Literal { kind: Char { terminated: true }, suffix_start: 6 }, len: 6 }
            Token { kind: Whitespace, len: 1 }
            Token { kind: UnknownPrefix, len: 1 }
            Token { kind: Literal { kind: Char { terminated: true }, suffix_start: 4 }, len: 4 }
            Token { kind: Whitespace, len: 1 }
            ...
            Token { kind: Whitespace, len: 1 }
            Token { kind: UnknownPrefix, len: 1 }
            Token { kind: Lifetime { starts_with_number: false }, len: 7 }
        "#]],
    );
}
