...
impl Target {
    ...
    pub fn from_item(item: &Item<'_>) -> Target {
        match item.kind {
            ...
            // Trust: Clean islands are inert module-shaped items for targeting.
            ItemKind::CleanIsland { .. } => Target::Mod,
    ...
    pub fn from_ast_item(item: &ast::Item) -> Target {
        match item.kind {
            ...
            // Trust: a Clean island is erased before HIR; attribute targeting
            // treats it like a module-shaped inert item.
            ast::ItemKind::CleanIsland(..) => Target::Mod,
