...
pub(crate) struct UnreachablePatternInner<'tcx> {
    ...
    #[note("to learn more about uninhabited types, see the Trust Nomicon's empty types section")]
...
#[note("for more information, see the Trust Book's refutability section")]
