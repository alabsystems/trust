...
- Generated: 2026-07-23T11:55:01Z
...
- trustjs cases: 67715 — covered 62359, equal 62359, divergent 0, no-coverage 5356

Top no-coverage reasons (top 20):

- 750 × loop iteration cap exceeded
- 211 × for-in over an object with unmodeled enumerable surface
- 202 × unimplemented intrinsic property `toString`
- 154 × unresolved identifier `AsyncDisposableStack` (unmodeled realm global or context-restricted binding)
...
- 72 × yield (S1e, out of slice)
- 64 × unimplemented intrinsic property `concat`
- 58 × eval body needs caller context (out of slice): 'super' property access outside of method
- 58 × unimplemented intrinsic property `toLocaleLowerCase`
- 58 × unimplemented intrinsic property `union`
