 ...
 * [The Trust documentation index](/index.html)
 * [The `trustc` book](/rustc/index.html)
...
function on_submit(event) {
    ...
    if (form['from'].value === 'duckduckgo') {
        document.location.href = form.action + '?q=' + encodeURIComponent(q + ' Trust documentation Trust');
