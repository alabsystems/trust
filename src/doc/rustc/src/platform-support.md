...
for targets at each tier, see the [Target Tier Policy].
...
see "Tier 1 with Host Tools" in the [Target Tier Policy].
...
the full requirements, see "Tier 1 target policy" in the [Target Tier
Policy].
...
the full requirements, see "Tier 2 target policy" in the [Target Tier
Policy].
