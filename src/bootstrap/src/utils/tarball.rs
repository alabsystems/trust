...
impl OverlayKind {
    fn legal_and_readme(&self) -> &[&str] {
        match self {
            ...
            OverlayKind::Cargo => &[
                "src/tools/targo/README.md",
                "src/tools/targo/LICENSE-MIT",
                "src/tools/targo/LICENSE-APACHE",
                "src/tools/targo/LICENSE-THIRD-PARTY",
            ],
            OverlayKind::TCargoTrust => {
                &["COPYRIGHT", "LICENSE-APACHE", "LICENSE-MIT", "targo-trust/README.md"]
            }
            OverlayKind::Clippy => &[
                "src/tools/tippy/README.md",
                "src/tools/tippy/LICENSE-APACHE",
                "src/tools/tippy/LICENSE-MIT",
            ],
            OverlayKind::Miri => &[
            ...
            OverlayKind::Rustfmt => &[
                "src/tools/trustfmt/README.md",
                "src/tools/trustfmt/LICENSE-APACHE",
                "src/tools/trustfmt/LICENSE-MIT",
            ],
    ...
    fn version(&self, builder: &Builder<'_>) -> String {
        match self {
            ...
            // release_num reads src/tools/<dir>/Cargo.toml — use the fork's
            // renamed tool dirs (targo / tippy / trustfmt), not the
            // upstream names, or dist/install panics on the missing path.
            OverlayKind::Cargo => {
                builder.cargo_info.version(builder, &builder.release_num("targo"))
            }
            OverlayKind::TCargoTrust => builder.rust_version(),
            OverlayKind::Clippy => {
                builder.clippy_info.version(builder, &builder.release_num("tippy"))
            }
            OverlayKind::Miri => builder.miri_info.version(builder, &builder.release_num("miri")),
            OverlayKind::Rustfmt => {
                builder.rustfmt_info.version(builder, &builder.release_num("trustfmt"))
            }
