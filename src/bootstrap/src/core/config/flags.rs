...
pub enum Subcommand {
    ...
    Arguments:
        ...
        to build. For example:
            ...
            ./x.py doc src/doc/rustc library/std
    ...
    Test {
        ...
        #[arg(long)]
        /// run upstream vanilla compiletest by disabling Trust verification
        trust_vanilla: bool,
        #[arg(long)]
...
impl Subcommand {
    ...
    pub fn trust_vanilla(&self) -> bool {
        match *self {
            Subcommand::Test { trust_vanilla, .. } => trust_vanilla,
            _ => false,
        }
    }
