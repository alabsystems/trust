...
lint_any!(
    ...
    Clippy, "src/tools/tippy", "clippy", Mode::ToolRustcPrivate;
    ...
    Rustfmt, "src/tools/trustfmt", "rustfmt", Mode::ToolRustcPrivate;
...
impl Step for CI {
    ...
    fn run(self, builder: &Builder<'_>) -> Self::Output {
        ...
        // So we want to lint stage 2 [bootstrap/rustc/...], but only stage 1 std.
