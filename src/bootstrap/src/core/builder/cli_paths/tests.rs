...
declare_tests!(
    ...
    (x_build_trustdoc, "build trustdoc"),
    (x_check, "check"),
    ...
    (x_check_trustdoc, "check trustdoc"),
    (x_clean, "clean"),
    (x_clippy, "clippy"),
    (x_dist, "dist"),
    (x_dist_rust_std, "dist rust-std"),
    (x_dist_rustc, "dist rustc"),
    (x_dist_trust_std, "dist trust-std"),
    (x_dist_trustc, "dist trustc"),
    (x_doc, "doc"),
    (x_fix, "fix"),
    (x_fmt, "fmt"),
    (x_install, "install"),
    (x_install_rust_std, "install rust-std"),
    (x_install_rustc, "install rustc"),
    (x_install_trust_std, "install trust-std"),
    (x_install_trustc, "install trustc"),
    (x_miri, "miri"),
    (x_run, "run"),
    (x_setup, "setup"),
    (x_test, "test"),
    ...
    // The skip combination upstream's second test-set split runs; pinned because it is
    // easy to break by accident and slow to notice.
    (
        x_test_skip_tests_etc,
        "test --skip=tests --skip=coverage-map --skip=coverage-run --skip=library --skip=tidyselftest"
    ),
    (x_test_targo, "test src/tools/targo"),
    (x_test_targo_trust, "test targo-trust"),
    ...
    (x_test_tippy, "test src/tools/tippy"),
    (x_test_ui, "test ui"),
    (x_vendor, "vendor"),
