...
pub fn main() -> ExitCode {
    ...
    rustc_driver::install_ice_hook_with_default_compiler(
        concat!(
            "https://github.com/alabsystems/Trust/issues/new",
            "?labels=C-bug%2C+I-ICE%2C+T-trustdoc",
        ),
        "trustdoc",
        |_| (),
    );
...
fn opts() -> Vec<RustcOptGroup> {
    ...
    vec![
        ...
        opt(Stable, FlagMulti, "V", "version", "print this documentation tool's version", ""),
        ...
        opt(Stable, Multi, "", "cfg", "pass a --cfg to trustc", ""),
        opt(Stable, Multi, "", "check-cfg", "pass a --check-cfg to trustc", ""),
        opt(Stable, Multi, "", "extern", "pass an --extern to trustc", "NAME[=PATH]"),
        opt(
            Unstable,
            Multi,
            "",
        ...
        opt(Stable, Multi, "C", "codegen", "pass a codegen option to trustc", "OPT[=VALUE]"),
        ...
        opt(
            ...
            "To add some CSS rules with a given file to generate doc with your own theme. \
                However, your theme might break if trustdoc's generated HTML changes, so be careful!",
            "PATH",
        ),
        opt(
            Unstable,
        ...
        opt(
            ...
            "",
            "default-setting",
            "Default value for a trustdoc setting (used when \"rustdoc-SETTING\" is absent \
        ...
        opt(
            ...
            "",
            "test-builder",
            "The trustc-like binary to use as the test builder",
            "PATH",
        ),
        opt(
            Unstable,
        ...
        opt(Unstable, FlagMulti, "", "check", "Run trustdoc checks", ""),
        opt(
            Unstable,
            FlagMulti,
            "",
        ...
        opt(
            ...
            "",
            "emit",
            "Comma separated list of types of output for trustdoc to emit",
        ...
        opt(
            ...
            "",
            "merge-doctests",
            "Force all doctests to be compiled as a single binary, instead of one binary per test. If merging fails, trustdoc will emit a hard error.",
            "yes|no|auto",
        ),
        opt(
            Unstable,
        ...
        opt(Stable, Multi, "", "plugin-path", "removed, see issue #44136", "DIR"),
        opt(Stable, Multi, "", "passes", "removed, see issue #44136", "PASSES"),
        opt(Stable, Multi, "", "plugins", "removed, see issue #44136", "PLUGINS"),
        opt(Stable, FlagMulti, "", "no-defaults", "removed, see issue #44136", ""),
        opt(Stable, Opt, "r", "input-format", "removed, see issue #44136", "[rust]"),
    ]
}
...
fn usage(argv0: &str) {
    ...
    println!("More information is shipped with this toolchain's documentation for {argv0}.",);
}
    ...
    interface::run_compiler(config, |compiler| {
        ...
        rustc_interface::create_and_enter_global_ctxt(compiler, krate, |tcx| {
            if sess.dcx().has_errors().is_some() {
                sess.dcx().fatal("Compilation failed, aborting trustdoc");
            }
