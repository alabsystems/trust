...
fn scrape_examples_help(shared: &SharedContext<'_>) -> String {
    ...
    content.push_str(&format!(
        "## More information\n\n\
      If you want more information about this feature, use the Trust documentation \
...
fn assoc_method(
    ...
    // FIXME: Once inherited tracking issue #143874 is implemented, we can remove this condition.
...
fn render_stability_since_raw_with_extra(
    ...
    if let Some(version) = stable_version.and_then(|version| since_to_string(&version)) {
        ...
        title.push_str(&format!("Stable since Trust version {version}"));
    }
...
///
/// See `src/doc/rustdoc/src/advanced-features.md` for the user-facing documentation.
