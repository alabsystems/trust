...
class DocSearch {
     ...
     * Parses the query.
     *
     * The supported syntax by this parser is given in the Trust documentation chapter
...
${obj.displayPath}<span class="${type}">${name}</span>\
    ...
    if (firstResult.value) {
        ...
        if (query.userQuery !== "") {
            ...
            "Try a narrower Trust documentation query, or use the documentation " +
...
async function search(forced) {
    ...
    searchState.title = "\"" + query.userQuery + "\" Search - Trust";
