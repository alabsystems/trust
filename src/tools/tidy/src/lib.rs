...
pub mod seed_freshness; // Trust: re-seed cadence invariant
pub mod style;
// Trust: the Trust-owned trees enter the style gate under a count ratchet.
pub mod style_ratcheted;
...
pub mod walk;
// Trust: `[workspace.lints]` is only policy once members opt in.
