...
/// Generate Trustfmt configuration parsing/formatting support for an enum.
///
/// Struct configuration values have no canonical string representation and
/// are rejected at compile time instead of crashing the procedural-macro host.
///
/// ```compile_fail
