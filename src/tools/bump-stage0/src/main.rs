...
const COMPILER_COMPONENTS: &[&str] = &[
    "trustc",
    "trust-std",
    "targo", // Trust: produced frontend component is targo
    "tippy-preview", // Trust: produced linter component is tippy
    "trustfmt-preview",
    "trust-docs",
    "targo-trust",
...
const RUSTFMT_COMPONENTS: &[&str] = &["trustfmt-preview", "trustc"];
