...
Tippy is Trust's lint frontend, built from the Clippy lint implementation to
catch common mistakes and improve Rust code. Its public commands are `tippy`,
`targo tippy`, and `tippy-driver`; the `clippy::` lint namespace remains stable
...
much Tippy is supposed to ~~annoy~~ help you by changing the lint level by
category.
