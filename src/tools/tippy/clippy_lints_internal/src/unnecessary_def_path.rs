                ...
                if let Some(name) = cx.tcx.get_diagnostic_name(def_id) {
                    span_lint_and_then(
                        ...
                        |diag| {
                            ...
                            diag.help("see also the Trust nightly compiler internals documentation for `diag`");
                        },
                    );
                    ...
                    span_lint_and_then(
                        ...
                        |diag| {
                            ...
                            diag.help("see also the Trust nightly compiler internals documentation for `lang`");
                        },
                    );
                }
            }
