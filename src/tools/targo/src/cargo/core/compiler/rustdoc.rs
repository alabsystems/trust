...
const TRUST_STD_DOCS_URL: &'static str = "https://andrewyates.github.io/Trust/";

/// Mode used for `std`. This is for unstable feature [`-Zrustdoc-map`][1].
///
/// [1]: https://andrewyates.github.io/Trust/cargo/reference/unstable.html#rustdoc-map
#[derive(Debug, Hash)]
pub enum RustdocExternMode {
    /// Use a local `file://` URL.
    Local,
    /// Use the Trust-owned remote docs URL (default).
    Remote,
    /// An arbitrary URL.
    Url(String),
}
...
///
/// [1]: https://andrewyates.github.io/Trust/rustdoc/unstable-features.html#--extern-html-root-url-control-how-rustdoc-links-to-non-local-crates
/// [2]: https://andrewyates.github.io/Trust/cargo/reference/unstable.html#rustdoc-map
pub fn add_root_urls(
    ...
    let std_url = match &map.std {
        None | Some(RustdocExternMode::Remote) => Some(TRUST_STD_DOCS_URL.to_string()),
