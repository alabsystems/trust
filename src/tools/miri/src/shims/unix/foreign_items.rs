        ...
        match link_name.as_str() {
            ...
            _ => {
                ...
                return match target_os {
                    Os::Android => android::EvalContextExt::emulate_foreign_item_inner(
                        this, link_name, abi, args, dest,
                    ),
                    Os::FreeBsd => freebsd::EvalContextExt::emulate_foreign_item_inner(
                        this, link_name, abi, args, dest,
                    ),
                    Os::Linux => linux::EvalContextExt::emulate_foreign_item_inner(
                        this, link_name, abi, args, dest,
                    ),
                    Os::MacOs => macos::EvalContextExt::emulate_foreign_item_inner(
                        this, link_name, abi, args, dest,
                    ),
