...
complete -c x -n "__fish_x_using_subcommand test" -l verbose-run-make-subprocess-output -d 'whether to show verbose subprocess output for run-make tests; set to false to suppress output for passing tests when using --no-capture' -r -f -a "{true\t'',false\t''}"
...
complete -c x -n "__fish_x_using_subcommand test" -l trust-vanilla -d 'run upstream vanilla compiletest by disabling Trust verification'
...
complete -c x -n "__fish_x_using_subcommand t" -l verbose-run-make-subprocess-output -d 'whether to show verbose subprocess output for run-make tests; set to false to suppress output for passing tests when using --no-capture' -r -f -a "{true\t'',false\t''}"
...
complete -c x -n "__fish_x_using_subcommand t" -l trust-vanilla -d 'run upstream vanilla compiletest by disabling Trust verification'
