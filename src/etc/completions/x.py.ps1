...
Register-ArgumentCompleter -Native -CommandName 'x.py' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'x.py' {
            ...
            [CompletionResult]::new('b', 'b', [CompletionResultType]::ParameterValue, 'Compile either the compiler or libraries')
            ...
            [CompletionResult]::new('c', 'c', [CompletionResultType]::ParameterValue, 'Compile either the compiler or libraries, using cargo check')
            ...
            [CompletionResult]::new('d', 'd', [CompletionResultType]::ParameterValue, 'Build documentation')
            [CompletionResult]::new('test', 'test', [CompletionResultType]::ParameterValue, 'Build and run some test suites')
            [CompletionResult]::new('t', 't', [CompletionResultType]::ParameterValue, 'Build and run some test suites')
            ...
            [CompletionResult]::new('r', 'r', [CompletionResultType]::ParameterValue, 'Run tools contained in this repository')
        ...
        'x.py;test' {
            ...
            [CompletionResult]::new('--verbose-run-make-subprocess-output', '--verbose-run-make-subprocess-output', [CompletionResultType]::ParameterName, 'whether to show verbose subprocess output for run-make tests; set to false to suppress output for passing tests when using --no-capture')
            ...
            [CompletionResult]::new('--trust-vanilla', '--trust-vanilla', [CompletionResultType]::ParameterName, 'run upstream vanilla compiletest by disabling Trust verification')
